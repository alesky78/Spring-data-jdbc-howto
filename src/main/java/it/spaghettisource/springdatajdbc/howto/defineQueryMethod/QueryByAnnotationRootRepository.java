...
public interface QueryByAnnotationRootRepository extends ListCrudRepository<QueryByAnnotationRoot,Long> {
    ...
    @Query("""
            SELECT QUERY_BY_ANNOTATION_ROOT.ID AS ID, QUERY_BY_ANNOTATION_ROOT.NAME AS NAME, QUERY_BY_ANNOTATION_ROOT.AGE AS AGE, QUERY_BY_ANNOTATION_ROOT.JOB AS JOB,
