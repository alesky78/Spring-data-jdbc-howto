...
INSERT INTO QUERY_BY_ANNOTATION_NESTED_ONE (ID, QUERY_BY_ANNOTATION_ROOT, NESTED_NAME) VALUES (1,1,'nested one');
INSERT INTO QUERY_BY_ANNOTATION_NESTED_MANY (ID, QUERY_BY_ANNOTATION_ROOT, ELEMENT) VALUES (1,1,'many first element');
INSERT INTO QUERY_BY_ANNOTATION_NESTED_MANY (ID, QUERY_BY_ANNOTATION_ROOT, ELEMENT) VALUES (2,1,'many second element');

INSERT INTO QUERY_BY_ANNOTATION_ROOT (ID, NAME, AGE, JOB) VALUES (2,'George', 47, 'DIRECTOR');
INSERT INTO QUERY_BY_ANNOTATION_NESTED_ONE (ID, QUERY_BY_ANNOTATION_ROOT, NESTED_NAME) VALUES (2,2,'nested one');
INSERT INTO QUERY_BY_ANNOTATION_NESTED_MANY (ID, QUERY_BY_ANNOTATION_ROOT, ELEMENT) VALUES (3,2,'many first element');
INSERT INTO QUERY_BY_ANNOTATION_NESTED_MANY (ID, QUERY_BY_ANNOTATION_ROOT, ELEMENT) VALUES (4,2,'many second element');
